        ...
        {dates.map((item, index) => (
          <View key={item}>
            <TouchableOpacity
              ...
              disabled={index === 0} // Disable the first date
            >
              <View style={{ flexDirection: 'row', height: Dimensions.get('window').width * 0.18 }}>
                ...
                <View style={{ alignSelf: 'center', justifyContent: 'space-between' }}>
                  ...
                  {index === 0 && (
                    <Text style={{ paddingHorizontal: 20, color: '#888', fontSize: 15 }}>Unavailable</Text>
                  )}
                </View>
              </View>
            </TouchableOpacity>
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        ...
                        props.route.params.onGoBack(slot, selectedDate);
                        props.navigation.goBack();
                      }}>
